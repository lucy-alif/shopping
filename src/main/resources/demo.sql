...
insert into student(stu_no,stu_name,stu_login,stu_passwd,stu_phone,stu_remain,stu_note,college_id)
	values('STU201806002','李四','lucy','8C7E1F3B1B787EC9F24FCC01E243E072','13812282812',66,'1班学生',1); 
insert into student(stu_no,stu_name,stu_login,stu_passwd,stu_phone,stu_remain,stu_note,college_id)
	values('STU201806003','张三1','tim','8C7E1F3B1B787EC9F24FCC01E243E072','13812282813',606,'2班学生',2); 
insert into student(stu_no,stu_name,stu_login,stu_passwd,stu_phone,stu_remain,stu_note,college_id)
	values('STU201806004','陈六','jack','8C7E1F3B1B787EC9F24FCC01E243E072','13812282814',600,'3班学生',3); 
